    ...
    <PostContent content={content}>
      <div>
        ...
        <h5>
          ...
          Q-switched lasers emit a centralised burst of light, targeting a specific spectrum of color represented in the
          tattoo (e.g. black, red, etc.). This means that for tattoos with differing colours, multiple lasers must be
          used. The laser is fired at these pigments, and as it hits, in nanoseconds they are heated up by thousands of
          ...
          break apart, while larger, stronger ones, merely vibrate. Once the tattoo pigment has been broken up into
        ...
        <h5>
          ...
          larger tattoos, with a total cost from anywhere between £270 to £600{' '}
