  ...
  return (
    <SubjectPage post={content} sidebarPresent={false}>
      ...
      <p>
        ...
        limit themselves, staying within mainstay commands. This article will investigate these
        litany of commands, and hopefully increase your understanding and productivity.
      </p>
      ...
      <p>
        ...
        Similar to merge, <i>rebase</i> can used to integrate changes from one branch, into another.
...
`}
      ...
      <p>
        ...
        tree. A <b>squash</b> will aggregate the commit messages of the combined commits, whilst a <b>fix</b> will ignore them
        completely.
      </p>
...
`}
      ...
      <p>
        ...
        <code className="language-git">6a4e34b</code> have been now moved inside <code className="language-git">d84b3e</code>,
        inheriting its commit message due to the use of the <b>fix</b> keyword.
      </p>
