...
const TextContainer = styled.div`
  ...
  width: ${(props: TextContainerStyleProps) =>
    props.sidebarPresent ? '66.6666666667%' : '100%'};
  float: left;
...
const TextHeader = styled.header`
  ...
  margin-bottom: 2em;
`;
const TextHeaderTitle = styled.h2`
  height: 100%;
  box-sizing: border-box;
  margin: 0;
  padding: 0;
  ...
  font-size: 2em;
`;
const TextHeaderSubTitle = styled.span`
  height: 100%;
  box-sizing: border-box;
  border: 0;
  font: inherit;
...
const SubjectPageText: FunctionComponent<PostParagraphProps> = ({
  post,
  sidebarPresent,
  children,
}) => {
