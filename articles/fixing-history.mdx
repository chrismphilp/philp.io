...
Relatively small changes, but the blog now feels slightly more polished reading app: no surprise redirects,
no glitchy fades, and an easy way to jump between posts in either direction. History is rewritten.
