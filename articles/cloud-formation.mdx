...
description: A brief overview of the formation of clouds.
date: '2022-06-05'
category: Science
---
...
Ever wondered how these wondrous 500,000 tonne masses (~3,000 houses) form and travel across the skyline each day? How come they
...
When water particles are heated to a sufficient degree, they evaporate into a gas known as water vapour.
During this transformation, the water vapour is able to absorb heat particles from
their surrounding area, cooling the original source down in the process. However, there's an issue. Air can only hold a
specific amount of water vapour at any given time, dependent on its temperature and weight – known as
atmospheric pressure. However, once it reaches its maximum threshold – known as the dew point - if a drop in temperature
...
### Why are they whiter than white?
...
relatively equally meaning no colour predominates, known as Mie Scattering. This means that to the
...
> Clouds began to appear on items produced during the Zhou dynasty, considered to be a symbol of good fortune in China.

> Greek philosopher Aristotle wrote Meteorologica, in which precipitation and the clouds from which precipitation fell
were called meteors, originating from the Greek word meteoros, meaning `high in the sky` and from this the modern term
